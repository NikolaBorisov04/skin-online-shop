...
import { PRODUCTS_FEATURE_KEY, productsReducer, ProductsEffects } from './pages/products/products.component';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects(HomeEffects, ContactEffects, ProductsEffects),
  ]
};
